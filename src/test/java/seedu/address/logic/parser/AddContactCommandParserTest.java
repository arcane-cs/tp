...
public class AddContactCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB, new AddContactCommand(expectedPerson));
    }
    ...
    public void parse_gamesAndAliases_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + GAME_DESC_MINECRAFT,
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + GAME_DESC_VALORANT + ALIAS_DESC_STEVE + ALIAS_DESC_JETT,
                new AddContactCommand(expectedPerson2));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + GAME_DESC_MINECRAFT + ALIAS_DESC_STEVE
                + GAME_DESC_VALORANT + ALIAS_DESC_JETT, new AddContactCommand(expectedPerson3));
    }
